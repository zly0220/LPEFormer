...
def get_dataloader(batch_size,fold_num,num_workers,width,add_file=None,train_idpd=None):
    ...
    # train_sampler = WeightedRandomSampler(train_dataset.sample_weight.tolist(),train_dataset.len)
...
# dataset = Seq_Pair_dataset("w2v.model", "dataset/1/cv_test_1.csv")
# loader = DataLoader(dataset,5,shuffle=False,num_workers=1,pin_memory=True)

# for A,B,C,D,E in loader:
#     batch_size = A.shape[0]
#     for idx in range(batch_size):
#         print(A[idx,:C[idx],:].shape)
#     break
